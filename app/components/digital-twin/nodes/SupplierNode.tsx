...
import { Factory, AlertTriangle, CheckCircle, AlertCircle } from 'lucide-react';
...
function SupplierNode({ data, selected }: { data: SupplierNodeData; selected?: boolean }) {
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-2">
        <div className={`p-1.5 rounded ${colors.bg}`}>
          <Factory className={`w-5 h-5 ${colors.icon}`} />
        </div>
      ...
      {/* Badge */}
      <div className="absolute -top-2 -right-2 px-2 py-0.5 bg-blue-600 rounded text-[10px] text-white font-medium">
        Supplier
      </div>
