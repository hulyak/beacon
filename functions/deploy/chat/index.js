 ...
 */
ff.http('chat', (0, utils_1.asyncHandler)(async (req, res) => {
    ...
    try {
        ...
        if (!message || typeof message !== 'string') {
            (0, utils_1.sendError)(res, 400, 'INVALID_MESSAGE', 'Message is required and must be a string');
            return;
        }
...
${conversationHistory ? `Previous Conversation:\n${conversationHistory}\n` : ''}`;
        const response = await geminiClient.generateContent(message, systemPrompt, {
            temperature: 0.7,
        ...
        (0, utils_1.sendError)(res, 500, 'CHAT_ERROR', 'Failed to process chat message', process.env.NODE_ENV === 'development' ? error : undefined);
    }
}));
/**
 ...
 * GET /metrics
 */
ff.http('getMetrics', (0, utils_1.asyncHandler)(async (req, res) => {
    const logger = (0, utils_1.createLogger)(req);
    ...
    try {
        ...
        (0, utils_1.sendSuccess)(res, metrics);
    }
    catch (error) {
        logger.error('Metrics error', error);
        (0, utils_1.sendError)(res, 500, 'METRICS_ERROR', 'Failed to fetch metrics');
    }
}));
/**
 ...
 * GET /network
 */
ff.http('getNetwork', (0, utils_1.asyncHandler)(async (req, res) => {
    const logger = (0, utils_1.createLogger)(req);
    ...
    try {
        ...
        const linkStatuses = ['active', 'active', 'active', 'delayed', 'disrupted'];
        ...
        (0, utils_1.sendError)(res, 500, 'NETWORK_ERROR', 'Failed to fetch network data');
    }
}));
