...
import { handleCors, sendSuccess, sendError, createLogger } from '../shared/utils';
 ...
 * }
 */
http('health', async (req: Request, res: Response): Promise<void> => {
 ...
 */
http('ping', (req: Request, res: Response): void => {
  if (handleCors(req, res)) {
    return;
  }
 ...
 */
http('ready', async (req: Request, res: Response): Promise<void> => {
  if (handleCors(req, res)) {
    return;
  }
 ...
 */
http('live', (req: Request, res: Response): void => {
  if (handleCors(req, res)) {
    return;
  }
