...
exports.calculateBatchROI = exports.calculateROI = void 0;
...
const calculateBatchROI = async (req, res) => {
    try {
        ...
        for (const strategy of strategies) {
            ...
            const mockReq = { body: strategy };
            const mockRes = {
                status: () => mockRes,
                json: (data) => data
            };
            try {
                await (0, exports.calculateROI)(mockReq, mockRes);
...
exports.calculateBatchROI = calculateBatchROI;
//# sourceMappingURL=calculate-roi.js.map