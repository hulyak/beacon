...
(0, functions_framework_1.http)('runScenario', (0, utils_1.asyncHandler)(async (req, res) => {
    ...
    try {
        ...
        let outcomes = generateOutcomes(scenarioType, severity || template.defaultSeverity);
        // Calculate financial impact
        let financialImpact = calculateFinancialImpact(scenarioType, severity || template.defaultSeverity, suppliers.length);
...
`;
                recommendation = await geminiClient.generateSupplyChainAnalysis(`Provide strategic recommendations for this scenario. Keep response under 3 sentences.`, analysisContext);
            }
            catch (geminiError) {
